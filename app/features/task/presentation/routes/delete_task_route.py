...
from app.features.task.presentation.schemas.task_error_message import (
    ErrorMessageTaskNotFound,
)
...
@router.delete(
    ...
    responses={status.HTTP_404_NOT_FOUND: {"model": ErrorMessageTaskNotFound}},
)
async def delete_task(
    ...
    try:
        task = await delete_task_use_case((id_,))
